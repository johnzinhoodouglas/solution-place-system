...
export const podeGerirVendas = (r: AppRole[]) =>
  has(r, "vendas") || has(r, "diretoria") || has(r, "master");
export const podeGerirCompras = (r: AppRole[]) =>
  has(r, "compras") || has(r, "diretoria") || has(r, "master");
export const podeGerirFinanceiro = (r: AppRole[]) =>
  has(r, "financeiro") || has(r, "diretoria") || has(r, "master");
export const podeGerirFiscal = (r: AppRole[]) =>
  has(r, "fiscal") || has(r, "diretoria") || has(r, "master");
