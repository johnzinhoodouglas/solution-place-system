            ...
            acoes.map((a) => (
              <div key={a.id} className="rounded-lg border border-border p-3 text-sm">
                ...
                <div className="mt-2 grid gap-2 text-xs text-muted-foreground sm:grid-cols-2">
                  ...
                  {a.when_prazo && (
                    <p>
                      <b>Prazo:</b> {new Date(a.when_prazo).toLocaleDateString("pt-BR")}
                    </p>
                  )}
                  {a.how_much !== null && (
                    <p>
                      <b>Custo:</b> R$ {Number(a.how_much).toFixed(2)}
                    </p>
                  )}
                </div>
                {pode && (
                  <div className="mt-2">
                    <Select
                      value={a.status}
                      onValueChange={(v) => updateAcaoStatus(a.id, v as AcaoStatus)}
                    >
