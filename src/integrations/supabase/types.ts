...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      acao_status: "planejada" | "em_execucao" | "concluida" | "verificada" | "cancelada";
      apontamento_status:
        | "em_execucao"
        | "concluido"
        | "pronto_limpeza"
      ...
      incidente_tipo:
        ...
        | "ambiental"
        | "patrimonial";
      inspecao_resultado: "pendente" | "aprovado" | "aprovado_condicional" | "reprovado";
      ...
      nc_status: "aberta" | "em_analise" | "em_acao" | "resolvida" | "verificada" | "fechada";
      ...
      os_evento:
        ...
        | "conclusao"
        | "cancelamento";
      os_status: "aberta" | "em_andamento" | "pausada" | "concluida" | "cancelada";
...
export const Constants = {
  public: {
    Enums: {
      acao_status: ["planejada", "em_execucao", "concluida", "verificada", "cancelada"],
      apontamento_status: ["em_execucao", "concluido", "pronto_limpeza", "reprovado", "retrabalho"],
      app_role: [
        "master",
        "diretoria",
        "qualidade",
      ...
      os_status: ["aberta", "em_andamento", "pausada", "concluida", "cancelada"],
      pedido_compra_status: ["rascunho", "aprovado", "enviado", "parcial", "recebido", "cancelado"],
      setor_producao: ["aco", "manta", "vidros", "montagem", "limpeza_envelopamento", "acabamento"],
      sucata_tipo: ["aco_304", "lataria", "vidro", "manta", "outros"],
      sugestao_status: [
        "nova",
        "em_analise",
